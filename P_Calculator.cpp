...
int main () { //DECLARING VARIABLES float palletWidth, palletHeight, palletLenght; float palletClass; int palletQty;

//RUNNING THE CALCULATOR UNTIL THE PALLET QTY = 0
while (palletQty != 0)
{ float totalVolume = 0; float totalWeight = 0;
...
cout << "Width: ";
cin >> palletWidth;
//HEIGHT SIZE PROMPT cout << "Height: "; cin >> palletHeight;
...
else if (palletClass < 50)
{
  ...
  /*
Class 55 35-50 pounds Class 60 30-35 pounds Class 65 22.5-30 pounds Class 70 15 to 22.5 pounds Class 77.5 13.5 to 15 pounds Class 85 12-13.5 pounds Class 92.5 10.5-12 pounds Class 100 9-10.5 pounds Class 110 8-9 pounds Class 125 7-8 pounds Class 150 6-7 pounds Class 175 5-6 pounds Class 200 4-5 pounds Class 250 3-4 pounds Class 300 2-3 pounds Class 400 1-2 pounds
